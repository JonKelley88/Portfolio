$(document).ready(function() {
	...
	function setColors(left, right) {
		let RGBString = $("#logo").css("background-image").split(",");
		leftRGB = [
	...
	let timer = setInterval(function() {
      ...
      rightRGB[0]
		...
		$("nav>div>div").css("background-image", string);
		...
		$("#workContainer>div:nth-child(1)>h3").css({
	...
	$("#skills>#left>div").hover(function() {
		...
		switch (skillsIndex) {
			case 0:
				$("#skills>#right").html("<div><p>Bootstrap</p></div><div><p>Responsive Design</p></div><div><p>Flexbox</p></div><div><p>SVG</p></div>").fadeIn();
				break;
			case 1:
				$("#skills>#right").html("<div><p>jQuery</p></div><div><p>ES2015+</p></div><div><p>React</p></div><div><p>node.js</p></div><div><p>D3</p></div>").fadeIn();
				break;
			case 2:
				$("#skills>#right").html("<div><p>Photo Editing</p></div><div><p>Vector Graphics</p></div><div><p>UI Design</p></div>").fadeIn();
				break;
			case 3:
				$("#skills>#right").html("<div><p>Object Oriented Programming</p></div><div><p>Agile Methodology</p></div><div><p>Debugging</p></div>").fadeIn();
				break;
		}
	}, function() {
		$("#skills>#left>div").css("background-size", "0% 100%");
